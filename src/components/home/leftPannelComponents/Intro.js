  ...
  return (
    <>
      ...
      <p className="  text-slate-400 leading-normal
        ...
        Notable startup background. Proven eye for design. Analytical, ever-curious, and a blazingly fast learner. Love working with people. Always ready to learn new tech.
        <br />
