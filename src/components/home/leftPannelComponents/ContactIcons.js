// flex flex-row text-slate-200
//                     absolute rb left-14
//                     md:justify-between
//                     lg:bottom-14 md:top-80 md:justify-start
...
export default function ContactIcons() {
  return (
    <div className={`${styles.contactIcons}
                    absolute flex flex-row text-slate-200
                    left-14
    `}>
      <Link target="_blank" href="https://www.github.com/gfrancomontero" className="mr-8 opacity-70 hover:opacity-100 cursor-pointer transition-ease">
      ...
      <Link target="_blank" href="https://www.linkedin.com/in/gfrancomontero" className="mr-8 opacity-70 hover:opacity-100 cursor-pointer transition-ease">
      ...
      <Link target="_blank" href="https://www.instagram.com/gonzalofranco123" className="mr-8 opacity-70 hover:opacity-100 cursor-pointer transition-ease">
      ...
      <Link target="_blank" href="https://www.x.com/gfrancomontero" className="opacity-70 hover:opacity-100 cursor-pointer transition-ease">
